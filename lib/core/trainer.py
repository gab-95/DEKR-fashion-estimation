...
#        print('do_train:: pheatmap, heatmap------->', pheatmap.size(), heatmap.size())
#        print('do_train:: poffset, offset------->', poffset.size(), offset.size(), offset_w.size())
        heatmap_loss, offset_loss = \
            loss_factory(pheatmap, poffset, heatmap, mask, offset, offset_w)
        print('do_train:: heatmap_loss-------->', heatmap_loss)
        print('do_train::offset_loss-------->', offset_loss)
        loss = 0
