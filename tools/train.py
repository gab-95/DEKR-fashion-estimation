...
def main_worker(
    ...
    print('train.py --> main() --> args.distributed:', args.distributed)
    if args.distributed:
    ...
    if args.distributed:
        print('train.py -->IN IFFF --> args.distributed:', args.distributed)
        # For multiprocessing distributed, DistributedDataParallel constructor
        # should always set the single device scope, otherwise,
        # DistributedDataParallel will use all available devices.
        if args.gpu is not None:
            print('train.py -->IN IFFF --> args.gpu:', args.gpu)
        ...
        print('train.py -->IN elifF --> args:', args.gpu)
        torch.cuda.set_device(int(args.gpu))
        model = model.cuda(int(args.gpu))
    else:
        print('train.py -->IN ELSE --> args:', args.gpu)
