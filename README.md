...
Run `python deepfashion2_cat1_to_coco.py` for train and validation datasetset to generate coco-type annotations from deepfashion2 dataset referred to category 1 ('short sleeve top')
